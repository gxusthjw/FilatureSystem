...
public interface IUnivariateIntegralFunction {
     ...
     * get the integral value of the analytic integral function
     * at independent variable {@code x}.</p>
     * <p>Create date:2018-11-20.</p>
     *
     * @param x independent Variable
     * @return the integral value of the analytic integral function
     ...
     * get the definite integral value at integrating range
     * [{@code x0},{@code x1}] of the analytic integral function.</p>
     * <p>Create date:2018-11-20.</p>
     *
