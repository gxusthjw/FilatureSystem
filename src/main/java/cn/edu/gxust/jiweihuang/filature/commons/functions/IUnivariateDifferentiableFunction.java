...
public interface IUnivariateDifferentiableFunction extends
     ...
     * @return the differential value of function with order
    ...
    /**
     * <p>The method {@code differential(double x)} is used to
     * get the differential value of function with {@code 1 order}
     * at independent variable {@code x}.</p>
     * <p>Create Date:2018-11-20</p>
     *
     * @param x independent variable
     * @return the differential value of function with {@code 1 order}
     * at independent variable {@code x}.
     * @author JiweiHuang
     * @since 1.0.0_build-20181120
     */
